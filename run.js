...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync('/mnt/user-data/outputs/LevitateOS_Platform_Documentation_Report.docx', buf);
  console.log('Done — LevitateOS_Platform_Documentation_Report.docx written.');
});
