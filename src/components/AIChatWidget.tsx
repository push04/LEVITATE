    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setMessages(prev => [...prev, { role: 'assistant', content: 'I could not generate a reply right now. Please try again.' }]);
            }
        } catch (e) {
            setMessages(prev => [...prev, { role: 'assistant', content: 'Network connection failed. Check your internet and try again.' }]);
        } finally {
            setIsLoading(false);
        }
    };
