                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="flex flex-wrap gap-2 mb-6">
                            ...
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full
                                ...
                                <span className="text-sm text-green-400 font-medium">
                                    🤖 100% AI-Automated Delivery
                                </span>
                            </div>
                        </div>

                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-heading leading-tight mb-6">
                            Full-Service <span className="text-[#0047FF]">Web Development</span>, <span className="text-[#00C853]">AI Automation</span> & <span className="text-[#FF4800]">Growth Marketing</span> Agency
                        </h1>

                        <p className="text-lg text-[var(--muted)] mb-8 max-w-lg">
                            From stunning websites to AI-automated pipelines — built and delivered by our agent network. No freelancer roulette. Real results, delivered in days, not weeks.
                        </p>
                        ...
                        <div className="flex gap-8 mt-12 pt-8 border-t border-[var(--border)]">
                            <div>
                                <div className="text-3xl font-bold text-[var(--primary)]">16</div>
                                <div className="text-sm text-[var(--muted)]">AI Agents</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-[var(--primary)]">24/7</div>
                                <div className="text-sm text-[var(--muted)]">Automated</div>
                            </div>
                            <div>
                                <div className="text-3xl font-bold text-[var(--primary)]">₹0</div>
                                <div className="text-sm text-[var(--muted)]">AI Cost</div>
                            </div>
                        </div>
                    </motion.div>
