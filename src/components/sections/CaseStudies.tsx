...
const caseStudies: CaseStudy[] = [
    {
        ...
        description: 'Full-Stack Marketplace Development: React & Serverless Architecture. Built a complete e-commerce marketplace platform from the ground up using modern serverless architecture. Features include secure user authentication, payment gateway integration with Razorpay, and role-based access control for buyers and sellers.',
        techStack: [
            { name: 'Serverless Functions', icon: Server },
    ...
    },
    {
        ...
        description: 'Premium WordPress Website with Custom Theme Development. Designed and developed a high-performance WordPress website with custom theme, SEO optimization, and fast loading speeds. Achieved 98+ SEO score and <2.5s LCP through careful optimization and Core Web Vitals tuning.',
        techStack: [
            ...
            <div className={`bg-gradient-to-r ${study.gradient} p-6 relative`}>
                <div className="flex items-center justify-between">
                    ...
                    <motion.div
                        ...
                        className="p-3 rounded-xl bg-white/20 backdrop-blur-sm text-white group-hover:bg-white group-hover:text-gray-900 transition-colors"
                    >
                ...
                <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {study.techStack.map((tech) => (
                            <div
                                key={tech.name}
                                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--secondary)] group-hover:bg-[var(--primary)]/10 transition-colors duration-300"
                            >
