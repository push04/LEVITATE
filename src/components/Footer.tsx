                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-[var(--muted)] text-sm mb-6">
                            Levitate Labs is a full-service digital agency specializing in custom web development, mechanical CAD design, growth marketing, and brand identity for startups and growing businesses.
                        </p>
                        {/* Social Links */}
