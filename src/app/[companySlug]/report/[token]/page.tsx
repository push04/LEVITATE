...
export default async function CompanySharedReportPage({
  params,
}: {
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-4">
              <LevitateLockup
                ...
                suffix="OS"
                subtitle="Shared business intelligence report"
                subtitleClassName="text-[#6d6155]"
              />
              <p className="max-w-3xl text-sm leading-7 text-[#6d6155]">
                This read-only backlink opens the saved market intelligence report exactly as it was shared from LevitateOS.
              </p>
            </div>
        ...
        <section className="rounded-[28px] border border-[#d9c8b4] bg-[linear-gradient(135deg,#25190f_0%,#3b2a19_100%)] p-6 text-[#f3eadf] shadow-[0_18px_50px_rgba(33,21,10,0.22)] md:p-8">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-2xl font-semibold text-[#fff7ee]">Subscribe to LevitateOS and generate your own research workspace.</h2>
              <p className="mt-3 max-w-3xl text-sm leading-7 text-[#d7c6b2]">
                Give your team a live market analysis engine, legal drafting tools, and an operating workspace built for Indian businesses.
              </p>
            </div>
