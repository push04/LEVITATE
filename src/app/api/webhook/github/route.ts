...
✅ If everything looks good, reply "APPROVED"
📝 If you'd like any changes, describe them

We'll make changes within 24 hours. 🙏`

        await sendWhatsAppToOwner(
          `✅ Website ready!\n${project.clients.business_name}\nStaging: ${staging_url}\n\nClient has been notified for review.`
        )
    ...
    if (event === 'coding_failed' && project_id) {
      ...
      await sendWhatsAppToOwner(`⚠️ Coding failed\nProject: ${project_id}\nError: ${error}\n\nDebugger triggered automatically.`)
