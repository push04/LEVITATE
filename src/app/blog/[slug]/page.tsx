    ...
    try {
        ...
        return {
            ...
            openGraph: {
                ...
                images: [
                    {
                        url: `https://levitatelabs.online/api/og?title=${encodeURIComponent(post.title)}&type=blog`,
                        width: 1200,
                        height: 630,
                        alt: post.title,
                    },
        ...
        return { title: 'Levitate Labs Blog', description: 'Insights and resources from Levitate Labs.' };
    }
}
